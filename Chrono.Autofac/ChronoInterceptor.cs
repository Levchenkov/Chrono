...
namespace Chrono.Autofac
{
    public class ChronoInterceptor : IInterceptor
    {
        ...
        private readonly IChronoSesssionIdProvider sessionIdHolder;


        public ChronoInterceptor(IClientService clientService, IChronoSesssionIdProvider sessionIdHolder)
        {
